      ...
      <div className="max-w-3xl mx-auto px-4 ">
        ...
        <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
          <p className="text-gray-300 mb-6">
            Dedicated full-stack developer with a passion for building scalable
            web applications and crafting innovative solutions that elevate user
            experiences.
          </p>
          ...
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                ...
                <p>
                  Provided remote customer support for SPIL products, conducted
                  installations, designed Crystal Reports, and managed technical
                  issues. Continuously improved skills in SQL Server and query
                  processing.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  Material UI, Bootstrap, Tailwind, MYSQL, Node.js, and Firebase
